        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="font-bold text-gray-900 text-xl mb-3 group-hover:text-indigo-600 transition-colors">
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-200">
                  {(project.demo || project.links?.demo) && (
                    <a
                      ...
                      className="flex-1 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-center text-sm font-semibold transform hover:scale-105 transition-all"
                    >
                      View Demo
                    </a>
                  )}
                  {(project.github || project.links?.github) && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 text-center text-sm font-semibold transform hover:scale-105 transition-all inline-flex items-center justify-center gap-2"
                    >
